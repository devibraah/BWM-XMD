...
adams({ nomCom: "info", categorie: 'Group' }, async (dest, zk, commandeOptions) => {
 ...
 adams({ nomCom: "antilink", categorie: 'Group', reaction: "⚔️" }, async (dest, zk, commandeOptions) => {
...
adams({ nomCom: "apk", reaction: "📂", categorie: "ibraah" }, async (dest, zk, commandeOptions) => {
